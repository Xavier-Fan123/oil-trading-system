...
public class SalesContract : BaseEntity
{
    ...
    // For SalesContract: Can be inherited from LinkedPurchaseContract's DealReferenceId
    // or generated independently for standalone sales
    // 鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺?

    /// <summary>
    /// Deal Reference ID - Lifecycle-spanning business identifier
    /// Inherited from linked PurchaseContract or generated independently
    /// </summary>
    ...
    /// Can inherit from linked PurchaseContract or set independently
    /// </summary>
    ...
    /// <summary>
    /// Inherit Deal Reference ID from linked PurchaseContract
    /// Call this after linking to a purchase contract that has a DealReferenceId
    /// </summary>
    public void InheritDealReferenceIdFromPurchase(string purchaseDealReferenceId, string updatedBy = "")
    {
        if (string.IsNullOrWhiteSpace(purchaseDealReferenceId))
            throw new DomainException("Purchase contract's Deal Reference ID cannot be empty");

        if (!LinkedPurchaseContractId.HasValue)
            throw new DomainException("Cannot inherit Deal Reference ID without a linked purchase contract");

        DealReferenceId = purchaseDealReferenceId.Trim().ToUpper();
        if (!string.IsNullOrEmpty(updatedBy))
        {
            SetUpdatedBy(updatedBy);
        }
    ...
    public void UpdateLaycan(DateTime laycanStart, DateTime laycanEnd)
    {
        ...
        // NOTE: Past date validation temporarily disabled for historical data import
        // Original validation:
    ...
    public void SetPricingPeriod(DateTime pricingPeriodStart, DateTime pricingPeriodEnd)
    {
        if (pricingPeriodStart >= pricingPeriodEnd)
            throw new DomainException("Pricing period start must be before pricing period end");
