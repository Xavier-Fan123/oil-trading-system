...
/// <summary>
/// SalesSettlement represents the financial confirmation and settlement of a sales contract.
///
/// Key Design Principles:
/// - One Sales Contract can have MULTIPLE settlements (one-to-many relationship)
...
///
/// Difference from PurchaseSettlement:
/// - SalesSettlement: Buyer confirms delivery, seller confirms payment collection
/// - PurchaseSettlement: Seller confirms delivery, buyer confirms payment
/// - Both follow same data structure but different business workflow
/// </summary>
public class SalesSettlement : BaseEntity
{
    private SalesSettlement() { } // For EF Core
        ...
        string createdBy = "System")
    {
        ...
        AddDomainEvent(new ContractSettlementCreatedEvent(Id, salesContractId, externalContractNumber));
    }

    // Foreign key and navigation
    public Guid SalesContractId { get; private set; }
    public SalesContract SalesContract { get; private set; } = null!;
    ...
    /// <summary>
    /// Deal Reference ID - Inherited from the sales contract this settlement belongs to
    ...
    public SalesSettlement? PreviousSettlement { get; private set; }
    public SalesSettlement? OriginalSettlement { get; private set; }
    ...
    /// <summary>
    /// Set the Deal Reference ID inherited from the sales contract
